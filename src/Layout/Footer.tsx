...
const Footer = () => {
  ...
  <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-8 sm:px-6 lg:px-8 lg:pt-24">
    <div className="text-center">
      ...
      Find colleges, compare courses, and track application steps — everything you need to get in and get going.
      </p>

      <Link
        to="/colleges"
        className="mt-8 inline-block rounded-full border border-red-600 px-12 py-3 text-sm font-medium  hover:bg-red-600 hover:text-white focus:ring-3 focus:outline-hidden"
      >
        Get Started
      </Link>
    </div>
